...
```json
{
  "applicationName" : "Sampledotnet-sample-5",
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=kadourah&repo=dotnet-sample-5",
  "projectName" : "dotnet-sample-5"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [Sample->Sampledotnet-sample-...(truncated)]
...
┃ ┃ ┃ ┃ ┗ ┗ Debug Path 'Sample.csproj' matched '^(?<folder>.*/)?(?<filename>([^/]+?|)(?=(?<ext>\.[^/.]*)?)$)' with groups {ext=.csproj, folder=null, filename=Sample.csproj, g0=Sample.csproj, g1=null, g2=Sample.csproj, g3=Sample.csproj, g4=.csproj} and was rewritten to 'Sampledotnet-sample-5.csproj'
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [sample-app->dotnet-sample-5]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=kadourah&repo=dotnet-sample-5'
